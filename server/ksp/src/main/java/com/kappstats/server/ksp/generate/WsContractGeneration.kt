package com.kappstats.server.ksp.generate
...
class WsContractGeneration(
    private val environment: SymbolProcessorEnvironment
) {
    fun generate(resolver: Resolver): OutputStream? {
        return try {
            val targetPackage = "com.kappstats.domain.web_socket.action"
